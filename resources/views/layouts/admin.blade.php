        ...
        <div class="flex items-center">
            ...
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    ...
                    <span class="role-text" style="margin-left:5px;">{{ Auth::user()->user_type }}</span>
                </x-slot>
                <x-slot name="content">
...
<aside class="sidebar">
    ...
    <nav class="space-y-2">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-2 px-3 py-2 transition-colors">
            <i class="fas fa-tachometer-alt"></i>
            <span>Dashboard</span>
        </a>
        <a href="{{ route('admin.users.index') }}" class="flex items-center space-x-2 px-3 py-2 transition-colors">
            <i class="fas fa-file-alt"></i>
            <span>Manage Users</span>
        </a>
        <a href="{{ route('admin.settings') }}" class="flex items-center space-x-2 px-3 py-2 transition-colors">
