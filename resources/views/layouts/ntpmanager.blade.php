...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }}- PDOHO</title>
...
<body>
        ...
        <div class="flex items-center">
            ...
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    ...
                    <span class="role-text" style="margin-left:0px;">{{ Auth::user()->user_type }}</span>
                </x-slot>
                <x-slot name="content">
    ...
    <aside class="sidebar">
        ...
        <nav class="space-y-2">
            <a href="{{ route('ntpmanager.dashboard') }}" class="flex items-center space-x-2 px-3 py-2 transition-colors">
                <i class="fas fa-tachometer-alt"></i>
                <span>Dashboard</span>
            </a>
            <a href="{{ route('ntpmanager.applications.index') }}" class="flex items-center space-x-2 px-3 py-2 transition-colors">
                <i class="fas fa-file-alt"></i>
                <span>Applications</span>
            </a>
            <a href="{{ route('ntpmanager.facilities') }}" class="flex items-center space-x-2 px-3 py-2 transition-colors">
